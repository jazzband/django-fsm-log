...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StateLog.description'
        db.add_column(u'django_fsm_log_statelog', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StateLog.description'
        db.delete_column(u'django_fsm_log_statelog', 'description')
